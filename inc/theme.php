...
<style type="text/css">
  body.login div#login h1 a {
  	background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/images/logo-new.png);
...
// Only allow certain emails to gain access to store portal
new GW_Email_Domain_Validator(array(
    'form_id' => 4,
    'field_id' => 3,
    'domains' => array('lowes.com', 'store.lowes.com'),
